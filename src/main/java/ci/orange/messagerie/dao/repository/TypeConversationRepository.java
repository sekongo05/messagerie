...
import ci.orange.messagerie.dao.repository.base._TypeConversationRepository;

/**
 * Repository : TypeConversation.
 *
 * @author Geo
 */
@Repository
public interface TypeConversationRepository extends JpaRepository<TypeConversation, Integer>, _TypeConversationRepository {
