...
import ci.orange.messagerie.dao.repository.base._TypeMessageRepository;

/**
 * Repository : TypeMessage.
 *
 * @author Geo
 */
@Repository
public interface TypeMessageRepository extends JpaRepository<TypeMessage, Integer>, _TypeMessageRepository {
